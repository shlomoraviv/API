...
.field private final hpackBuffer:Lax/wc/e;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Writer$Companion;-><init>(Lax/Fb/g;)V
...
.method public constructor <init>(Lax/wc/f;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lax/wc/f;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Writer;->client:Z

    new-instance v4, Lax/wc/e;

    invoke-direct {v4}, Lax/wc/e;-><init>()V

    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lax/wc/e;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLax/wc/e;ILax/Fb/g;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lax/wc/f;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lax/wc/e;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lax/wc/f;
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lax/wc/h;

    invoke-virtual {v2}, Lax/wc/h;->s()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lax/wc/h;

    invoke-interface {v0, v1}, Lax/wc/f;->a1(Lax/wc/h;)Lax/wc/f;
...
.method public final declared-synchronized data(ZILax/wc/e;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILax/wc/e;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILax/wc/e;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, Lax/wc/A;->write(Lax/wc/e;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {p1, v5}, Lokhttp3/internal/Util;->writeMedium(Lax/wc/f;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lax/wc/f;

    and-int/lit16 p2, v6, 0xff

    invoke-interface {p1, p2}, Lax/wc/f;->writeByte(I)Lax/wc/f;
    ...
    invoke-interface {p1, p2}, Lax/wc/f;->writeInt(I)Lax/wc/f;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lax/wc/f;->writeInt(I)Lax/wc/f;
    ...
    invoke-interface {p1, p3}, Lax/wc/f;->write([B)Lax/wc/f;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lax/wc/e;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lax/wc/e;

    invoke-interface {p1, v4, v2, v3}, Lax/wc/A;->write(Lax/wc/e;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lax/wc/f;->writeInt(I)Lax/wc/f;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lax/wc/f;

    const v5, 0x7fffffff

    and-int/2addr p2, v5

    invoke-interface {v2, p2}, Lax/wc/f;->writeInt(I)Lax/wc/f;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lax/wc/f;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lax/wc/e;

    invoke-interface {p2, v2, v3, v4}, Lax/wc/A;->write(Lax/wc/e;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lax/wc/f;

    invoke-interface {v3, v0}, Lax/wc/f;->writeShort(I)Lax/wc/f;
    ...
    invoke-interface {v0, v3}, Lax/wc/f;->writeInt(I)Lax/wc/f;
