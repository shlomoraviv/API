...
.field public sink:Lax/wc/f;

.field public socket:Ljava/net/Socket;

.field public source:Lax/wc/g;
...
.method public static synthetic socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lax/wc/g;Lax/wc/f;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 0
    ...
    invoke-static {p1}, Lax/wc/p;->l(Ljava/net/Socket;)Lax/wc/C;

    move-result-object p3

    invoke-static {p3}, Lax/wc/p;->d(Lax/wc/C;)Lax/wc/g;
    ...
    invoke-static {p1}, Lax/wc/p;->h(Ljava/net/Socket;)Lax/wc/A;

    move-result-object p4

    invoke-static {p4}, Lax/wc/p;->c(Lax/wc/A;)Lax/wc/f;

    move-result-object p4

    :cond_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lax/wc/g;Lax/wc/f;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final getSink$okhttp()Lax/wc/f;
    .locals 1

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lax/wc/f;
...
.method public final getSource$okhttp()Lax/wc/g;
    .locals 1

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lax/wc/g;
...
.method public final setSink$okhttp(Lax/wc/f;)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lax/wc/f;
...
.method public final setSource$okhttp(Lax/wc/g;)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lax/wc/g;
...
.method public final socket(Ljava/net/Socket;)Lokhttp3/internal/http2/Http2Connection$Builder;
    ...
    invoke-static/range {v1 .. v7}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lax/wc/g;Lax/wc/f;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lax/wc/g;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lax/wc/g;Lax/wc/f;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p3}, Lokhttp3/internal/http2/Http2Connection$Builder;->setSource$okhttp(Lax/wc/g;)V

    invoke-virtual {p0, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->setSink$okhttp(Lax/wc/f;)V
