...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lax/Fb/g;)V
...
.method public constructor <init>(Lax/wc/g;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Reader;->client:Z

    new-instance v2, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lax/wc/g;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lax/wc/C;IIILax/Fb/g;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILax/wc/g;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lax/wc/g;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;

    invoke-interface {p4}, Lax/wc/g;->readInt()I

    move-result p4

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;

    invoke-interface {v0}, Lax/wc/g;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lax/wc/g;->A(J)Lax/wc/h;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lax/wc/h;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;

    invoke-interface {p2}, Lax/wc/g;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;

    invoke-interface {v3}, Lax/wc/g;->readByte()B
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lax/Kb/g;->j(II)Lax/Kb/c;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lax/Kb/g;->i(Lax/Kb/a;I)Lax/Kb/a;
    ...
    invoke-interface {v3}, Lax/wc/g;->readShort()S
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lax/wc/g;

    invoke-interface {v4}, Lax/wc/g;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lax/wc/g;)I
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lax/wc/h;
    ...
    invoke-interface {p1, v1, v2}, Lax/wc/g;->A(J)Lax/wc/h;
