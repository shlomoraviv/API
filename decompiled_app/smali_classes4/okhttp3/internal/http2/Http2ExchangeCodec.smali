...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2ExchangeCodec$Companion;-><init>(Lax/Fb/g;)V
...
.method public createRequestBody(Lokhttp3/Request;J)Lax/wc/A;
    .locals 0
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lax/wc/A;
...
.method public finishRequest()V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lax/wc/A;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lax/wc/C;
    .locals 1
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()Lax/wc/D;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lax/wc/D;->timeout(JLjava/util/concurrent/TimeUnit;)Lax/wc/D;

    iget-object p1, p0, Lokhttp3/internal/http2/Http2ExchangeCodec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-static {p1}, Lax/Fb/l;->c(Ljava/lang/Object;)V

    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()Lax/wc/D;
