...
# direct methods
.method public constructor <init>(Lax/wc/C;I)V
    .locals 7
...
.method public constructor <init>(Lax/wc/C;II)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lax/wc/g;
...
.method public synthetic constructor <init>(Lax/wc/C;IIILax/Fb/g;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lax/wc/C;II)V
...
.method private final clearDynamicTable()V
    ...
    invoke-static/range {v0 .. v5}, Lax/sb/h;->p([Ljava/lang/Object;Ljava/lang/Object;IIILjava/lang/Object;)V
...
.method private final getName(I)Lax/wc/h;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lax/wc/h;
...
.method private final readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lax/wc/g;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lax/wc/h;

    move-result-object p1

    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lax/wc/h;

    move-result-object v0

    new-instance v1, Lokhttp3/internal/http2/Header;

    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lax/wc/h;Lax/wc/h;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lax/wc/h;)Lax/wc/h;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lax/wc/h;Lax/wc/h;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lax/wc/h;Lax/wc/h;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lax/wc/h;Lax/wc/h;)V
...
.method public final readByteString()Lax/wc/h;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lax/wc/g;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Lax/wc/g;JLax/wc/f;)V
    ...
    invoke-interface {v0, v2, v3}, Lax/wc/g;->A(J)Lax/wc/h;
