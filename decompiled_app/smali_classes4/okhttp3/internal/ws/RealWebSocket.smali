...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/ws/RealWebSocket$Companion;-><init>(Lax/Fb/g;)V
...
.method public constructor <init>(Lokhttp3/internal/concurrent/TaskRunner;Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;JLokhttp3/internal/ws/WebSocketExtensions;J)V
    ...
    sget-object p2, Lax/wc/h;->Z:Lax/wc/h$a;
    ...
    invoke-static/range {p2 .. p7}, Lax/wc/h$a;->f(Lax/wc/h$a;[BIIILjava/lang/Object;)Lax/wc/h;

    move-result-object p1

    invoke-virtual {p1}, Lax/wc/h;->g()Ljava/lang/String;
...
.method private final isValid(Lokhttp3/internal/ws/WebSocketExtensions;)Z
    ...
    invoke-direct {v0, v2, v3}, Lax/Kb/c;-><init>(II)V
...
.method private final declared-synchronized send(Lax/wc/h;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILax/wc/h;)V
...
.method public final checkUpgradeSuccess$okhttp(Lokhttp3/Response;Lokhttp3/internal/connection/Exchange;)V
    ...
    invoke-static {v4, v0, v5}, Lax/Nb/g;->r(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v0}, Lax/wc/h;->A()Lax/wc/h;
...
.method public final declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILax/wc/h;J)V
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    invoke-virtual {p2}, Lokhttp3/internal/ws/RealWebSocket$Streams;->getSink()Lax/wc/f;
    ...
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLax/wc/f;Ljava/util/Random;ZZJ)V
    ...
    invoke-virtual {p2}, Lokhttp3/internal/ws/RealWebSocket$Streams;->getSource()Lax/wc/g;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLax/wc/g;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
...
.method public onReadMessage(Lax/wc/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lax/wc/h;)V
...
.method public declared-synchronized onReadPing(Lax/wc/h;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lax/wc/h;)V
    .locals 1
...
.method public final declared-synchronized pong(Lax/wc/h;)Z
    .locals 1
...
.method public send(Lax/wc/h;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lax/wc/h;I)Z
...
.method public final writeOneFrame$okhttp()Z
    ...
    :goto_2
    :try_start_2
    sget-object v6, Lax/rb/t;->a:Lax/rb/t;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lax/wc/h;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Message;->getData()Lax/wc/h;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writeMessageFrame(ILax/wc/h;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Close;->getReason()Lax/wc/h;

    move-result-object v4

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILax/wc/h;)V

    if-eqz v5, :cond_7

    iget-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->listener:Lokhttp3/WebSocketListener;

    invoke-static {v7}, Lax/Fb/l;->c(Ljava/lang/Object;)V
...
.method public final writePingFrame$okhttp()V
    ...
    :cond_3
    :try_start_3
    sget-object v1, Lax/wc/h;->k0:Lax/wc/h;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lax/wc/h;)V
    :try_end_3
