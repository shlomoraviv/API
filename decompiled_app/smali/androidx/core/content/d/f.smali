...
.method public static c(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Landroidx/core/content/d/f;->j(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
...
.method public static f(Landroid/content/Context;I)Landroid/graphics/Typeface;
    ...
    invoke-static/range {v0 .. v7}, Landroidx/core/content/d/f;->l(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method public static g(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;)Landroid/graphics/Typeface;
    .locals 8
...
.method public static h(Landroid/content/Context;ILandroidx/core/content/d/f$c;Landroid/os/Handler;)V
    .locals 8

    invoke-static {p2}, Lb/h/k/h;->f(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, p0, p3}, Landroidx/core/content/d/f$c;->callbackFailAsync(ILandroid/os/Handler;)V
...
.method private static j(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    .locals 2

    invoke-static {p0, p1}, Landroidx/core/content/d/f;->k(Landroid/content/res/Resources;I)Z
...
.method private static k(Landroid/content/res/Resources;I)Z
    .locals 2

    invoke-static {}, Landroidx/core/content/d/f;->i()Landroid/util/TypedValue;
...
.method private static l(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 10
    ...
    invoke-static/range {v0 .. v8}, Landroidx/core/content/d/f;->m(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method private static m(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 15
    ...
    invoke-virtual {v9, v13, v10}, Landroidx/core/content/d/f$c;->callbackFailAsync(ILandroid/os/Handler;)V

    :cond_0
    return-object v14

    :cond_1
    invoke-static {v0, v4, v5}, Lb/h/d/e;->f(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v9, v1, v10}, Landroidx/core/content/d/f$c;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-static/range {v1 .. v8}, Lb/h/d/e;->c(Landroid/content/Context;Landroidx/core/content/d/c$a;Landroid/content/res/Resources;IILandroidx/core/content/d/f$c;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    invoke-static {p0, v0, v4, v12, v5}, Lb/h/d/e;->d(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v9, v0, v10}, Landroidx/core/content/d/f$c;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
