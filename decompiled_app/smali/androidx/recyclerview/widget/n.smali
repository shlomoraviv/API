...
.method private l(Landroidx/recyclerview/widget/RecyclerView$p;Landroidx/recyclerview/widget/m;)Landroid/view/View;
    .locals 8
    ...
    .line 3
    invoke-virtual {p1, v4}, Landroidx/recyclerview/widget/RecyclerView$p;->I(I)Landroid/view/View;
...
.method private m(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/m;
    .locals 1
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/m;->a:Landroidx/recyclerview/widget/RecyclerView$p;

    if-eq v0, p1, :cond_1

    .line 2
    :cond_0
    invoke-static {p1}, Landroidx/recyclerview/widget/m;->a(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/m;
...
.method private n(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/m;
    .locals 1
    ...
    .line 2
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/n;->o(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/m;
    ...
    .line 4
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/n;->m(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/m;
...
.method private o(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/m;
    .locals 1
    ...
    .line 2
    :cond_0
    invoke-static {p1}, Landroidx/recyclerview/widget/m;->c(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/m;
...
.method public f(Landroidx/recyclerview/widget/RecyclerView$p;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/recyclerview/widget/n;->l(Landroidx/recyclerview/widget/RecyclerView$p;Landroidx/recyclerview/widget/m;)Landroid/view/View;
...
.method public g(Landroidx/recyclerview/widget/RecyclerView$p;II)I
    ...
    .line 2
    :cond_0
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/n;->n(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/m;
    ...
    .line 6
    :cond_5
    invoke-direct {p0, p1, p2, p3}, Landroidx/recyclerview/widget/n;->p(Landroidx/recyclerview/widget/RecyclerView$p;II)Z
    ...
    .line 10
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/n;->q(Landroidx/recyclerview/widget/RecyclerView$p;)Z
