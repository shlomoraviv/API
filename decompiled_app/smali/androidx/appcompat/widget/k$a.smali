...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/H;->c(Landroid/content/Context;I)I

    move-result v2

    sget v3, Lax/m/a;->u:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/H;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/H;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/H;->e:[I

    const/4 v3, 0x1

    aput-object p1, v1, v3

    invoke-static {v2, p2}, Lax/T/a;->g(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Landroidx/appcompat/widget/H;->c:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/H;->i:[I
...
.method private i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/H;->c(Landroid/content/Context;I)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/H;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v2, Landroidx/appcompat/widget/H;->b:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/H;->f:[I
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/H;->b(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v6

    sget-object v3, Landroidx/appcompat/widget/H;->f:[I

    aput-object v3, v1, v5

    sget v3, Lax/m/a;->v:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/H;->c(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v5

    sget-object v3, Landroidx/appcompat/widget/H;->i:[I
...
.method private l(Landroidx/appcompat/widget/C;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    ...
    invoke-virtual {p1, p2, v2}, Landroidx/appcompat/widget/C;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    sget v3, Lax/m/e;->G:I

    invoke-virtual {p1, p2, v3}, Landroidx/appcompat/widget/C;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/H;->c(Landroid/content/Context;I)I
...
.method public c(Landroidx/appcompat/widget/C;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/C;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Lax/m/e;->k:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/C;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/k$a;->l(Landroidx/appcompat/widget/C;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Lax/o/a;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/H;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/H;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/H;->b(Landroid/content/Context;I)I
