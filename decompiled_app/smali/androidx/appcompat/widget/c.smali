...
.field private final D0:Landroid/util/SparseBooleanArray;

.field E0:Landroidx/appcompat/widget/c$e;

.field F0:Landroidx/appcompat/widget/c$a;

.field G0:Landroidx/appcompat/widget/c$c;

.field private H0:Landroidx/appcompat/widget/c$b;

.field final I0:Landroidx/appcompat/widget/c$f;

.field J0:I

.field q0:Landroidx/appcompat/widget/c$d;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->D0:Landroid/util/SparseBooleanArray;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->I0:Landroidx/appcompat/widget/c$f;
...
.method static synthetic r(Landroidx/appcompat/widget/c;)Landroidx/appcompat/view/menu/e;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/a;->Y:Landroidx/appcompat/view/menu/e;
...
.method static synthetic t(Landroidx/appcompat/widget/c;)Landroidx/appcompat/view/menu/k;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/a;->o0:Landroidx/appcompat/view/menu/k;
...
.method private z(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/a;->o0:Landroidx/appcompat/view/menu/k;
...
.method public A()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c;->q0:Landroidx/appcompat/widget/c$d;
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->s0:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroidx/appcompat/widget/c;->r0:Landroid/graphics/drawable/Drawable;
...
.method public B()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c;->G0:Landroidx/appcompat/widget/c$c;

    const/4 v1, 0x1

    if-eqz v0, :cond_0

    iget-object v2, p0, Landroidx/appcompat/view/menu/a;->o0:Landroidx/appcompat/view/menu/k;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/c;->G0:Landroidx/appcompat/widget/c$c;

    return v1

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/c;->E0:Landroidx/appcompat/widget/c$e;
...
.method public C()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c;->F0:Landroidx/appcompat/widget/c$a;
...
.method public F(Landroid/content/res/Configuration;)V
    ...
    iget-boolean p1, p0, Landroidx/appcompat/widget/c;->y0:Z

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/appcompat/view/menu/a;->X:Landroid/content/Context;

    invoke-static {p1}, Lax/s/a;->b(Landroid/content/Context;)Lax/s/a;

    move-result-object p1

    invoke-virtual {p1}, Lax/s/a;->d()I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/c;->x0:I

    :cond_0
    iget-object p1, p0, Landroidx/appcompat/view/menu/a;->Y:Landroidx/appcompat/view/menu/e;
...
.method public H(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/a;->o0:Landroidx/appcompat/view/menu/k;

    iget-object v0, p0, Landroidx/appcompat/view/menu/a;->Y:Landroidx/appcompat/view/menu/e;
...
.method public I(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/c;->s0:Z

    iput-object p1, p0, Landroidx/appcompat/widget/c;->r0:Landroid/graphics/drawable/Drawable;
...
.method public J(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/c;->t0:Z

    const/4 p1, 0x1

    iput-boolean p1, p0, Landroidx/appcompat/widget/c;->u0:Z
...
.method public K()Z
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->t0:Z
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/a;->o0:Landroidx/appcompat/view/menu/k;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroidx/appcompat/widget/c;->G0:Landroidx/appcompat/widget/c$c;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/a;->X:Landroid/content/Context;

    iget-object v4, p0, Landroidx/appcompat/view/menu/a;->Y:Landroidx/appcompat/view/menu/e;

    iget-object v5, p0, Landroidx/appcompat/widget/c;->q0:Landroidx/appcompat/widget/c$d;
    ...
    iput-object v0, v2, Landroidx/appcompat/widget/c;->G0:Landroidx/appcompat/widget/c$c;

    iget-object v1, v2, Landroidx/appcompat/view/menu/a;->o0:Landroidx/appcompat/view/menu/k;
...
.method public c(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/k$a;)V
    ...
    invoke-interface {p2, p1, v0}, Landroidx/appcompat/view/menu/k$a;->f(Landroidx/appcompat/view/menu/g;I)V

    iget-object p1, p0, Landroidx/appcompat/view/menu/a;->o0:Landroidx/appcompat/view/menu/k;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/c;->H0:Landroidx/appcompat/widget/c$b;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->H0:Landroidx/appcompat/widget/c$b;
...
.method public d(Z)V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/view/menu/g;->b()Lax/c0/b;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, Lax/c0/b;->i(Lax/c0/b$a;)V
    ...
    :goto_1
    iget-boolean v1, p0, Landroidx/appcompat/widget/c;->t0:Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/c;->q0:Landroidx/appcompat/widget/c$d;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->q0:Landroidx/appcompat/widget/c$d;
...
.method public e()Z
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/a;->Y:Landroidx/appcompat/view/menu/e;
    ...
    :goto_0
    iget v5, v0, Landroidx/appcompat/widget/c;->x0:I

    iget v6, v0, Landroidx/appcompat/widget/c;->w0:I

    invoke-static {v3, v3}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v7

    iget-object v8, v0, Landroidx/appcompat/view/menu/a;->o0:Landroidx/appcompat/view/menu/k;
    ...
    :goto_2
    iget-boolean v13, v0, Landroidx/appcompat/widget/c;->B0:Z
    ...
    :cond_4
    iget-boolean v9, v0, Landroidx/appcompat/widget/c;->t0:Z
    ...
    iget-object v9, v0, Landroidx/appcompat/widget/c;->D0:Landroid/util/SparseBooleanArray;

    invoke-virtual {v9}, Landroid/util/SparseBooleanArray;->clear()V

    iget-boolean v10, v0, Landroidx/appcompat/widget/c;->z0:Z

    if-eqz v10, :cond_7

    iget v10, v0, Landroidx/appcompat/widget/c;->C0:I
    ...
    iget-boolean v2, v0, Landroidx/appcompat/widget/c;->z0:Z
    ...
    iget-boolean v3, v0, Landroidx/appcompat/widget/c;->z0:Z
    ...
    :cond_11
    iget-boolean v4, v0, Landroidx/appcompat/widget/c;->z0:Z
...
.method public i(Landroid/content/Context;Landroidx/appcompat/view/menu/e;)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->u0:Z

    if-nez v0, :cond_0

    invoke-virtual {p1}, Lax/s/a;->h()Z

    move-result v0

    iput-boolean v0, p0, Landroidx/appcompat/widget/c;->t0:Z
    ...
    invoke-virtual {p1}, Lax/s/a;->c()I

    move-result v0

    iput v0, p0, Landroidx/appcompat/widget/c;->v0:I

    :cond_1
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->y0:Z
    ...
    :cond_2
    iget p1, p0, Landroidx/appcompat/widget/c;->v0:I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/c;->q0:Landroidx/appcompat/widget/c$d;

    iget-boolean v2, p0, Landroidx/appcompat/widget/c;->s0:Z

    const/4 v3, 0x0

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroidx/appcompat/widget/c;->r0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/AppCompatImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v1, p0, Landroidx/appcompat/widget/c;->r0:Landroid/graphics/drawable/Drawable;

    iput-boolean v3, p0, Landroidx/appcompat/widget/c;->s0:Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/c;->q0:Landroidx/appcompat/widget/c$d;
    ...
    :cond_5
    iput-object v1, p0, Landroidx/appcompat/widget/c;->q0:Landroidx/appcompat/widget/c$d;

    :goto_0
    iput p1, p0, Landroidx/appcompat/widget/c;->w0:I
    ...
    iput p1, p0, Landroidx/appcompat/widget/c;->C0:I
...
.method public k(Landroidx/appcompat/view/menu/m;)Z
    ...
    :goto_0
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/m;->g0()Landroid/view/Menu;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/a;->Y:Landroidx/appcompat/view/menu/e;
    ...
    iput v2, p0, Landroidx/appcompat/widget/c;->J0:I
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/c;->F0:Landroidx/appcompat/widget/c$a;
