...
.method public L0(Landroid/os/Bundle;)V
    ...
    .line 6
    iget v0, p0, Landroidx/preference/f;->w0:I
...
.method public L1(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 2
    iput v0, p0, Landroidx/preference/f;->y0:I
    ...
    iget-object v1, p0, Landroidx/preference/f;->x0:Landroid/graphics/drawable/BitmapDrawable;

    .line 5
    invoke-virtual {v0, v1}, Landroidx/appcompat/app/b$a;->e(Landroid/graphics/drawable/Drawable;)Landroidx/appcompat/app/b$a;
    ...
    .line 6
    invoke-virtual {v0, v1, p0}, Landroidx/appcompat/app/b$a;->j(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/b$a;
    ...
    .line 7
    invoke-virtual {v0, v1, p0}, Landroidx/appcompat/app/b$a;->h(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/b$a;

    move-result-object v0

    .line 8
    invoke-virtual {p0, p1}, Landroidx/preference/f;->U1(Landroid/content/Context;)Landroid/view/View;
    ...
    .line 9
    invoke-virtual {p0, p1}, Landroidx/preference/f;->T1(Landroid/view/View;)V

    .line 10
    invoke-virtual {v0, p1}, Landroidx/appcompat/app/b$a;->n(Landroid/view/View;)Landroidx/appcompat/app/b$a;

    goto :goto_0

    .line 11
    :cond_0
    iget-object p1, p0, Landroidx/preference/f;->v0:Ljava/lang/CharSequence;

    invoke-virtual {v0, p1}, Landroidx/appcompat/app/b$a;->f(Ljava/lang/CharSequence;)Landroidx/appcompat/app/b$a;

    .line 12
    :goto_0
    invoke-virtual {p0, v0}, Landroidx/preference/f;->W1(Landroidx/appcompat/app/b$a;)V
    ...
    .line 14
    invoke-virtual {p0}, Landroidx/preference/f;->S1()Z
    ...
    .line 15
    invoke-direct {p0, p1}, Landroidx/preference/f;->X1(Landroid/app/Dialog;)V

    :cond_1
    return-object p1
.end method

.method public R1()Landroidx/preference/DialogPreference;
    .locals 2
...
.method protected T1(Landroid/view/View;)V
    .locals 3
...
.method protected U1(Landroid/content/Context;)Landroid/view/View;
    .locals 2
...
.method protected W1(Landroidx/appcompat/app/b$a;)V
    .locals 0
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/preference/f;->V1(Z)V
...
.method public p0(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1}, Landroidx/preference/DialogPreference;->K0()I
    ...
    invoke-virtual {p1}, Landroidx/preference/DialogPreference;->J0()Landroid/graphics/drawable/Drawable;
