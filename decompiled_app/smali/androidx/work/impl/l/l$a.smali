...
.method public bridge synthetic g(Lb/s/a/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/l/l$a;->i(Lb/s/a/f;Landroidx/work/impl/l/j;)V

    return-void
.end method

.method public i(Lb/s/a/f;Landroidx/work/impl/l/j;)V
    .locals 10
    ...
    invoke-interface {p1, v1, v2, v3}, Lb/s/a/d;->x(IJ)V
    ...
    :cond_3
    invoke-interface {p1, v1, v0}, Lb/s/a/d;->A(I[B)V
    ...
    invoke-interface {p1, v6, v8, v9}, Lb/s/a/d;->x(IJ)V
    ...
    invoke-interface {p1, v5, v8, v9}, Lb/s/a/d;->x(IJ)V
    ...
    invoke-interface {p1, v4, v5, v6}, Lb/s/a/d;->x(IJ)V
    ...
    invoke-interface {p1, v3, v4, v5}, Lb/s/a/d;->x(IJ)V
    ...
    invoke-interface {p1, v2, v3, v4}, Lb/s/a/d;->x(IJ)V
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, Lb/s/a/d;->A(I[B)V

    goto :goto_6

    :cond_6
    invoke-interface {p1, v6}, Lb/s/a/d;->p(I)V

    invoke-interface {p1, v5}, Lb/s/a/d;->p(I)V

    invoke-interface {p1, v4}, Lb/s/a/d;->p(I)V

    invoke-interface {p1, v3}, Lb/s/a/d;->p(I)V

    invoke-interface {p1, v2}, Lb/s/a/d;->p(I)V
    ...
    :goto_5
    invoke-interface {p1, v7}, Lb/s/a/d;->p(I)V
