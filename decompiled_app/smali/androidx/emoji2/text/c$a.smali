...
.method private a(Landroid/content/Context;Lax/Z/i;)Landroidx/emoji2/text/e$b;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/k;-><init>(Landroid/content/Context;Lax/Z/i;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lax/Z/i;
    .locals 3
    ...
    new-instance v1, Lax/Z/i;

    const-string v2, "emojicompat-emoji-font"

    invoke-direct {v1, v0, p1, v2, p2}, Lax/Z/i;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
# virtual methods
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/e$b;
    .locals 1

    invoke-virtual {p0, p1}, Landroidx/emoji2/text/c$a;->h(Landroid/content/Context;)Lax/Z/i;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/c$a;->a(Landroid/content/Context;Lax/Z/i;)Landroidx/emoji2/text/e$b;
...
.method h(Landroid/content/Context;)Lax/Z/i;
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/c$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lax/Z/i;
