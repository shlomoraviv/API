...
.method private static b(Landroid/text/Editable;Landroid/view/KeyEvent;Z)Z
    ...
    invoke-static {p1}, Landroidx/emoji2/text/e;->g(Landroid/view/KeyEvent;)Z
    ...
    invoke-static {p1, v1}, Landroidx/emoji2/text/e;->f(II)Z
...
.method static c(Landroid/view/inputmethod/InputConnection;Landroid/text/Editable;IIZ)Z
    ...
    invoke-static {v1, v2}, Landroidx/emoji2/text/e;->f(II)Z
...
.method static d(Landroid/text/Editable;ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-static {p0, p2, v1}, Landroidx/emoji2/text/e;->b(Landroid/text/Editable;Landroid/view/KeyEvent;Z)Z
    ...
    :cond_1
    invoke-static {p0, p2, v2}, Landroidx/emoji2/text/e;->b(Landroid/text/Editable;Landroid/view/KeyEvent;Z)Z
...
.method private e(Ljava/lang/CharSequence;IILandroidx/emoji2/text/d;)Z
    .locals 2

    invoke-virtual {p4}, Landroidx/emoji2/text/d;->d()I
    ...
    invoke-virtual {p4}, Landroidx/emoji2/text/d;->h()S
    ...
    invoke-virtual {p4, p1}, Landroidx/emoji2/text/d;->k(Z)V
...
.method h(Ljava/lang/CharSequence;IIIZ)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v4}, Landroidx/emoji2/text/i;->f()Landroidx/emoji2/text/i$a;
    ...
    invoke-virtual {v3}, Landroidx/emoji2/text/e$c;->c()Landroidx/emoji2/text/d;

    move-result-object v6

    invoke-direct {p0, p1, v1, p2, v6}, Landroidx/emoji2/text/e;->e(Ljava/lang/CharSequence;IILandroidx/emoji2/text/d;)Z
    ...
    :cond_10
    invoke-virtual {v3}, Landroidx/emoji2/text/e$c;->e()Z
    ...
    invoke-direct {p0, p1, v1, p2, p3}, Landroidx/emoji2/text/e;->e(Ljava/lang/CharSequence;IILandroidx/emoji2/text/d;)Z
    ...
    invoke-virtual {p1}, Landroidx/emoji2/text/j;->d()V
    ...
    invoke-virtual {p2}, Landroidx/emoji2/text/j;->d()V
