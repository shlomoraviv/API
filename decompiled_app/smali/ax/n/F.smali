...
# static fields
.field private static d:Lax/n/F;
...
.method static b()Lax/n/F;
    .locals 2

    sget-object v0, Lax/n/F;->d:Lax/n/F;

    if-nez v0, :cond_0

    new-instance v0, Lax/n/F;

    const/4 v1, 0x1

    invoke-direct {v0}, Lax/n/F;-><init>()V

    const/4 v1, 0x5

    sput-object v0, Lax/n/F;->d:Lax/n/F;
...
.method public a(JDD)V
    ...
    iput v6, p0, Lax/n/F;->c:I

    iput-wide v10, p0, Lax/n/F;->a:J

    iput-wide v10, p0, Lax/n/F;->b:J
    ...
    iput-wide v2, p0, Lax/n/F;->b:J

    cmp-long v0, v2, p1

    if-gez v0, :cond_2

    iget-wide v0, p0, Lax/n/F;->a:J
