...
.method private A5(Ljava/util/List;)V
    .locals 3
...
.method private B5()V
    ...
    iget-object v0, p0, Lax/S1/Z;->Q1:Lax/o2/d;
    ...
    new-instance v1, Lax/S1/Z$b;

    invoke-direct {v1, p0}, Lax/S1/Z$b;-><init>(Lax/S1/Z;)V
    ...
    new-instance v1, Lax/S1/Z$c;

    const/4 v5, 0x3

    invoke-direct {v1, p0}, Lax/S1/Z$c;-><init>(Lax/S1/Z;)V
...
.method private C5(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lax/S1/Z;->N1:Z
    ...
    iget-object p1, p0, Lax/S1/Z;->I1:Landroidx/recyclerview/widget/RecyclerView;

    const/4 v4, 0x0

    invoke-virtual {p1, v0}, Landroid/view/View;->setVisibility(I)V

    iget-object p1, p0, Lax/S1/Z;->J1:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p1, v1}, Landroid/view/View;->setVisibility(I)V

    const/4 v4, 0x7

    iget-object p1, p0, Lax/S1/Z;->K1:Lax/o2/A;
    ...
    iput-object p1, p0, Lax/S1/Z;->K1:Lax/o2/A;

    const/4 v4, 0x1

    iget-object v2, p0, Lax/S1/Z;->J1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v2, p0, Lax/S1/Z;->K1:Lax/o2/A;

    invoke-direct {p1, v2, v0, v1}, Lax/o2/o;-><init>(Lax/o2/o$a;ZZ)V

    const/4 v4, 0x6

    iput-object p1, p0, Lax/S1/Z;->O1:Lax/o2/o;
    ...
    new-instance v2, Lax/S1/Z$j;

    invoke-direct {v2, p0, v1}, Lax/S1/Z$j;-><init>(Lax/S1/Z;Landroidx/recyclerview/widget/i;)V
    ...
    invoke-static {v1}, Lcom/alphainventor/filemanager/file/N;->e(Landroid/content/Context;)Ljava/util/List;
    ...
    iget-object v3, p0, Lax/S1/Z;->K1:Lax/o2/A;
    ...
    iget-object p1, p0, Lax/S1/Z;->L1:Lax/o2/A;
...
.method static synthetic k5(Lax/S1/Z;)Lax/o2/B;
    .locals 1

    iget-object p0, p0, Lax/S1/Z;->P1:Lax/o2/B;
...
.method static synthetic l5(Lax/S1/Z;)Lax/o2/d;
    .locals 1

    iget-object p0, p0, Lax/S1/Z;->Q1:Lax/o2/d;

    return-object p0
.end method

.method static synthetic m5(Lax/S1/Z;I)Z
    .locals 1

    invoke-direct {p0, p1}, Lax/S1/Z;->z5(I)Z
...
.method static synthetic n5(Lax/S1/Z;)Landroidx/appcompat/view/a$a;
    .locals 1

    const/4 v0, 0x6

    iget-object p0, p0, Lax/S1/Z;->R1:Landroidx/appcompat/view/a$a;

    return-object p0
.end method

.method static synthetic o5(Lax/S1/Z;)Lax/o2/A;
    .locals 1

    iget-object p0, p0, Lax/S1/Z;->L1:Lax/o2/A;

    return-object p0
.end method

.method static synthetic p5(Lax/S1/Z;Ljava/util/List;)V
    .locals 1

    invoke-direct {p0, p1}, Lax/S1/Z;->x5(Ljava/util/List;)V
...
.method static synthetic q5(Lax/S1/Z;Ljava/util/List;)V
    .locals 1

    invoke-direct {p0, p1}, Lax/S1/Z;->A5(Ljava/util/List;)V
...
.method static synthetic r5(Lax/S1/Z;Ljava/util/List;)V
    .locals 1

    invoke-direct {p0, p1}, Lax/S1/Z;->w5(Ljava/util/List;)V

    return-void
.end method

.method static synthetic s5(Lax/S1/Z;Ljava/util/List;)V
    .locals 1

    invoke-direct {p0, p1}, Lax/S1/Z;->v5(Ljava/util/List;)V
...
.method static synthetic t5(Lax/S1/Z;Ljava/util/List;)V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, p1}, Lax/S1/Z;->u5(Ljava/util/List;)V
...
.method private w5(Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    invoke-static {v0}, Lax/P1/r;->B3(Ljava/util/List;)Lax/P1/r;
...
.method private x5(Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    invoke-static {p1}, Lax/P1/u;->T3(Lax/R1/I;)Lax/P1/u;
    ...
    invoke-virtual {p0, p1, v0, v2}, Lax/S1/l;->O(Landroidx/fragment/app/e;Ljava/lang/String;Z)Z

    return-void
.end method

.method private z5(I)Z
    .locals 6
    ...
    invoke-virtual {p0}, Lax/S1/Z;->y5()Ljava/util/List;
    ...
    iget-object v0, p0, Lax/S1/Z;->L1:Lax/o2/A;
    ...
    iget-object v3, p0, Lax/S1/Z;->L1:Lax/o2/A;
    ...
    :cond_2
    iget-object v0, p0, Lax/S1/Z;->P1:Lax/o2/B;
...
.method public D3()V
    ...
    iget-object v0, p0, Lax/S1/Z;->I1:Landroidx/recyclerview/widget/RecyclerView;
...
.method public H(I)V
    ...
    invoke-virtual {p0, v0}, Lax/S1/Z;->v4(Z)V
...
.method public T1(Landroid/view/MenuItem;)Z
    ...
    :cond_0
    invoke-direct {p0, v2}, Lax/S1/Z;->C5(Z)V
...
.method public X1(Landroid/view/Menu;)V
    ...
    iget-object v1, p0, Lax/S1/Z;->L1:Lax/o2/A;
...
.method public c(Lax/G1/f;I)V
    ...
    const-string v1, "nfrooteegarmte_"
...
.method public d2(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object p2, p0, Lax/S1/Z;->Q1:Lax/o2/d;

    const/4 v5, 0x0

    invoke-direct {p0}, Lax/S1/Z;->B5()V
    ...
    iput-object p2, p0, Lax/S1/Z;->I1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p2, p0, Lax/S1/Z;->I1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p1, p0, Lax/S1/Z;->J1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    new-instance p1, Lax/S1/Z$d;

    invoke-direct {p1, p0}, Lax/S1/Z$d;-><init>(Lax/S1/Z;)V

    const/4 v5, 0x2

    iput-object p1, p0, Lax/S1/Z;->R1:Landroidx/appcompat/view/a$a;

    const/4 v5, 0x0

    new-instance p1, Lax/S1/Z$e;

    const/4 v5, 0x5

    invoke-direct {p1, p0}, Lax/S1/Z$e;-><init>(Lax/S1/Z;)V
    ...
    iput-object p2, p0, Lax/S1/Z;->L1:Lax/o2/A;
    ...
    iput-object p1, p0, Lax/S1/Z;->M1:Lax/o2/z;
    ...
    iget-object v2, p0, Lax/S1/Z;->M1:Lax/o2/z;
    ...
    iget-object p2, p0, Lax/S1/Z;->L1:Lax/o2/A;
    ...
    iput-object p1, p0, Lax/S1/Z;->P1:Lax/o2/B;
    ...
    iget-object p1, p0, Lax/S1/Z;->P1:Lax/o2/B;
    ...
    new-instance p2, Lax/S1/Z$f;

    const/4 v5, 0x4

    invoke-direct {p2, p0}, Lax/S1/Z$f;-><init>(Lax/S1/Z;)V

    invoke-virtual {p1, p2}, Lax/X0/I;->a(Lax/X0/I$b;)V

    const/4 v5, 0x2

    iget-object p1, p0, Lax/S1/Z;->M1:Lax/o2/z;

    new-instance p2, Lax/S1/Z$g;

    invoke-direct {p2, p0}, Lax/S1/Z$g;-><init>(Lax/S1/Z;)V
    ...
    new-instance p2, Lax/S1/Z$h;

    const/4 v5, 0x1

    invoke-direct {p2, p0}, Lax/S1/Z$h;-><init>(Lax/S1/Z;)V
    ...
    new-instance p2, Lax/S1/Z$i;

    invoke-direct {p2, p0}, Lax/S1/Z$i;-><init>(Lax/S1/Z;)V
...
.method protected n4(Lax/S1/l$p;)V
    ...
    iget-object p1, p0, Lax/S1/Z;->Q1:Lax/o2/d;
    ...
    invoke-direct {p0, v1}, Lax/S1/Z;->C5(Z)V
...
.method public q0(Lax/T/b;Z)V
    ...
    iget-object v1, p0, Lax/S1/Z;->I1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v2, p0, Lax/S1/Z;->I1:Landroidx/recyclerview/widget/RecyclerView;
...
.method public y5()Ljava/util/List;
    ...
    iget-object v1, p0, Lax/S1/Z;->P1:Lax/o2/B;
    ...
    iget-object v3, p0, Lax/S1/Z;->P1:Lax/o2/B;
