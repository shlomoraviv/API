...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lax/P1/r;->B1:Landroid/os/Handler;

    return-void
.end method

.method static synthetic A3(Lax/P1/r;)Ljava/util/List;
    .locals 1

    const/4 v0, 0x1

    iget-object p0, p0, Lax/P1/r;->A1:Ljava/util/List;
...
.method public static B3(Ljava/util/List;)Lax/P1/r;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v0, Lax/P1/r;

    const/4 v6, 0x2

    invoke-direct {v0}, Lax/P1/r;-><init>()V
...
.method static synthetic z3(Lax/P1/r;)Ljava/util/List;
    .locals 1

    const/4 v0, 0x2

    iget-object p0, p0, Lax/P1/r;->z1:Ljava/util/List;
...
.method public w3()V
    ...
    iput-object v0, p0, Lax/P1/r;->z1:Ljava/util/List;

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->A0()Landroid/os/Bundle;

    move-result-object v0

    const-string v1, "eyks"
    ...
    iput-object v0, p0, Lax/P1/r;->A1:Ljava/util/List;
...
.method public x3()Landroid/app/Dialog;
    ...
    iget-object v2, p0, Lax/P1/r;->z1:Ljava/util/List;
    ...
    new-instance v1, Lax/P1/r$a;

    const/4 v5, 0x3

    invoke-direct {v1, p0}, Lax/P1/r$a;-><init>(Lax/P1/r;)V
