...
.field private Y:Landroid/media/session/MediaSession$QueueItem;
...
.method private constructor <init>(Landroid/media/session/MediaSession$QueueItem;Landroid/support/v4/media/MediaDescriptionCompat;J)V
    ...
    iput-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->q:Landroid/support/v4/media/MediaDescriptionCompat;

    iput-wide p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->X:J

    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->Y:Landroid/media/session/MediaSession$QueueItem;
...
.method public e()Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->Y:Landroid/media/session/MediaSession$QueueItem;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->q:Landroid/support/v4/media/MediaDescriptionCompat;

    invoke-virtual {v0}, Landroid/support/v4/media/MediaDescriptionCompat;->e()Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->Y:Landroid/media/session/MediaSession$QueueItem;
