...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v0 .. v6}, Landroid/support/v4/media/session/MediaSessionCompat;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Lax/m1/b;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Lax/m1/b;)V
    .locals 2
    ...
    invoke-direct {p3, p1, p2, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$g;-><init>(Landroid/content/Context;Ljava/lang/String;Lax/m1/b;Landroid/os/Bundle;)V
    ...
    invoke-direct {p3, p1, p2, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$f;-><init>(Landroid/content/Context;Ljava/lang/String;Lax/m1/b;Landroid/os/Bundle;)V
    ...
    invoke-direct {p3, p1, p2, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$e;-><init>(Landroid/content/Context;Ljava/lang/String;Lax/m1/b;Landroid/os/Bundle;)V
    ...
    invoke-direct {p3, p1, p2, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$d;-><init>(Landroid/content/Context;Ljava/lang/String;Lax/m1/b;Landroid/os/Bundle;)V
...
.method public g(Z)V
    ...
    check-cast v2, Landroid/support/v4/media/session/MediaSessionCompat$h;

    invoke-interface {v2}, Landroid/support/v4/media/session/MediaSessionCompat$h;->a()V
...
.method public m(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->o(Landroid/support/v4/media/session/PlaybackStateCompat;)V
...
.method public n(Ljava/util/List;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->m(Ljava/util/List;)V
...
.method public o(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->i(Ljava/lang/CharSequence;)V
...
.method public p(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->W(I)V
...
.method public q(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->q0(I)V
