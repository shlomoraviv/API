...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    :cond_0
    instance-of v0, p0, La/t9;

    if-eqz v0, :cond_1

    check-cast p0, La/t9;

    invoke-interface {p0, p1}, La/t9;->setTintList(Landroid/content/res/ColorStateList;)V
...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, La/t9;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method public static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    sput-object v0, La/s9;->a:Ljava/lang/reflect/Method;

    sget-object v0, La/s9;->a:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v4, La/s9;->b:Z

    :cond_1
    sget-object v2, La/s9;->a:Ljava/lang/reflect/Method;
...
.method public static b(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_0
    invoke-static {v0}, La/s9;->b(Landroid/graphics/drawable/Drawable;)V

    goto :goto_2

    :cond_2
    instance-of v0, p0, La/u9;

    if-eqz v0, :cond_3

    check-cast p0, La/u9;

    invoke-interface {p0}, La/u9;->a()Landroid/graphics/drawable/Drawable;
...
.method public static b(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-interface {p0, p1}, La/t9;->setTint(I)V
...
.method public static e(Landroid/graphics/drawable/Drawable;)I
    ...
    sput-object v0, La/s9;->c:Ljava/lang/reflect/Method;

    sget-object v0, La/s9;->c:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v3, La/s9;->d:Z

    :cond_1
    sget-object v1, La/s9;->c:Ljava/lang/reflect/Method;
...
.method public static i(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, p0}, La/w9;-><init>(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v0, p0}, La/v9;-><init>(Landroid/graphics/drawable/Drawable;)V
