...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lb/q/b;->a:Ljava/io/File;

    iput-object p2, p0, Lb/q/b;->c:Ljava/io/File;

    invoke-static {p1}, Lb/q/b;->J(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Lb/q/b;->b:J
    ...
    iput-object p2, p0, Lb/q/b;->d:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Lb/q/b;->e:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Lb/q/b;->f:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, Lb/q/b;->e:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Lb/q/b;->D(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, Lb/q/b;->d:Ljava/io/RandomAccessFile;
...
.method private static G(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lb/q/b;->D(Ljava/io/Closeable;)V
...
.method private static J(Ljava/io/File;)J
    ...
    invoke-static {p0}, Lb/q/c;->c(Ljava/io/File;)J
...
.method private static K(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p0}, Lb/q/b;->H(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, Lb/q/b;->I(Ljava/io/File;)J
...
.method private M(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Lb/q/b;->a:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Lb/q/b;->H(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, Lb/q/b$b;

    iget-object v9, v0, Lb/q/b;->c:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Lb/q/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lb/q/b;->J(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Lb/q/b$b;->a:J
...
.method private N()Ljava/util/List;
    ...
    iget-object v6, v1, Lb/q/b;->a:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, Lb/q/b;->l()V
    ...
    iget-object v0, v1, Lb/q/b;->a:Ljava/io/File;
    ...
    new-instance v11, Lb/q/b$b;

    iget-object v12, v1, Lb/q/b;->c:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Lb/q/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v10, v11, v6}, Lb/q/b;->G(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Lb/q/b;->J(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Lb/q/b$b;->a:J
    :try_end_1
    ...
    iget-wide v12, v11, Lb/q/b$b;->a:J
...
.method private l()V
    ...
    iget-object v0, p0, Lb/q/b;->c:Ljava/io/File;

    new-instance v1, Lb/q/b$a;

    invoke-direct {v1, p0}, Lb/q/b$a;-><init>(Lb/q/b;)V
    ...
    iget-object v2, p0, Lb/q/b;->c:Ljava/io/File;
...
.method L(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v1, p0, Lb/q/b;->a:Ljava/io/File;
    ...
    iget-object v0, p0, Lb/q/b;->f:Ljava/nio/channels/FileLock;
    ...
    iget-object v0, p0, Lb/q/b;->a:Ljava/io/File;

    iget-wide v2, p0, Lb/q/b;->b:J

    invoke-static {p1, v0, v2, v3, p2}, Lb/q/b;->K(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lb/q/b;->M(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_1
    invoke-direct {p0}, Lb/q/b;->N()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Lb/q/b;->a:Ljava/io/File;

    invoke-static {v0}, Lb/q/b;->I(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Lb/q/b;->b:J
    ...
    invoke-static/range {v2 .. v8}, Lb/q/b;->O(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public close()V
    ...
    iget-object v0, p0, Lb/q/b;->e:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    iget-object v0, p0, Lb/q/b;->d:Ljava/io/RandomAccessFile;
