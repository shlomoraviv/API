...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->k0:Landroid/graphics/RectF;

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->l0:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->k0:Landroid/graphics/RectF;

    const/4 p1, 0x2

    new-array p1, p1, [I

    iput-object p1, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->l0:[I
...
.method private O(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    :cond_0
    instance-of v0, p1, Lax/k7/b;

    if-nez v0, :cond_2

    instance-of v0, p1, Lax/k7/a;
...
.method private P(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lax/y6/i;Lax/y6/i;FFFFLandroid/graphics/RectF;)V
    .locals 0

    invoke-direct {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->W(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lax/y6/i;FF)F

    move-result p3

    invoke-direct {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->W(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lax/y6/i;FF)F
    ...
    iget-object p4, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->k0:Landroid/graphics/RectF;
...
.method private Q(Landroid/view/View;Landroid/graphics/RectF;)V
    ...
    iget p1, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->m0:F

    iget v0, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->n0:F
...
.method private R(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lax/y6/h;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Lax/y6/h;->e(Ljava/lang/String;)Lax/y6/i;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lax/y6/h;

    const-string p3, "translationYCurveUpwards"

    invoke-virtual {p2, p3}, Lax/y6/h;->e(Ljava/lang/String;)Lax/y6/i;
...
.method private S(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
    .locals 2

    iget-object v0, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->Z:Landroid/graphics/RectF;

    iget-object v1, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->k0:Landroid/graphics/RectF;
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->U(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
...
.method private T(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->V(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
...
.method private U(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
    .locals 2
...
.method private V(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
    .locals 2
...
.method private W(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lax/y6/i;FF)F
    .locals 8

    invoke-virtual {p2}, Lax/y6/i;->c()J

    move-result-wide v0

    invoke-virtual {p2}, Lax/y6/i;->d()J

    move-result-wide v2

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lax/y6/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Lax/y6/h;->e(Ljava/lang/String;)Lax/y6/i;
    ...
    invoke-virtual {p2}, Lax/y6/i;->e()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Lax/y6/a;->a(FFF)F
...
.method private X(Landroid/view/View;Landroid/graphics/RectF;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->l0:[I
...
.method private Y(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    sget-object p3, Lax/y6/d;->a:Landroid/util/Property;
    ...
    :goto_1
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lax/y6/h;
    ...
    invoke-virtual {p2, p1}, Lax/y6/i;->a(Landroid/animation/Animator;)V
...
.method private Z(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {p2, p1}, Lax/K6/c;->setCircularRevealScrimColor(I)V

    :cond_1
    sget-object p1, Lax/K6/c$d;->a:Landroid/util/Property;
    ...
    :cond_2
    sget-object p3, Lax/K6/c$d;->a:Landroid/util/Property;
...
.method private a0(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    iget-object v2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lax/y6/j;

    invoke-direct {p0, p1, p2, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->U(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F

    move-result v2

    iget-object v3, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lax/y6/j;

    invoke-direct {p0, p1, p2, v3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->V(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
    ...
    check-cast v3, Lax/y6/i;

    iget-object p4, p4, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast p4, Lax/y6/i;
    ...
    :cond_0
    iget v2, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->m0:F
    ...
    :cond_1
    iget p2, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->n0:F
    ...
    invoke-virtual {v3, v2}, Lax/y6/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {p4, p1}, Lax/y6/i;->a(Landroid/animation/Animator;)V
...
.method private c0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    check-cast v12, Lax/K6/c;

    iget-object v2, v8, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lax/y6/j;

    invoke-direct {p0, v0, v1, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F

    move-result v3

    iget-object v2, v8, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lax/y6/j;

    invoke-direct {p0, v0, v1, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->T(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
    ...
    iget-object v0, v8, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lax/y6/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Lax/y6/h;->e(Ljava/lang/String;)Lax/y6/i;
    ...
    new-instance v0, Lax/K6/c$e;

    invoke-direct {v0, v3, v4, v10}, Lax/K6/c$e;-><init>(FFF)V

    invoke-interface {v12, v0}, Lax/K6/c;->setRevealInfo(Lax/K6/c$e;)V

    :cond_1
    if-eqz p4, :cond_2

    invoke-interface {v12}, Lax/K6/c;->getRevealInfo()Lax/K6/c$e;

    move-result-object v0

    iget v10, v0, Lax/K6/c$e;->c:F
    ...
    invoke-static/range {v3 .. v8}, Lax/T6/a;->c(FFFFFF)F

    move-result v0

    invoke-static {v12, v3, v4, v0}, Lax/K6/a;->a(Lax/K6/c;FFF)Landroid/animation/Animator;

    move-result-object v8

    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$d;

    invoke-direct {v0, p0, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lax/K6/c;)V

    invoke-virtual {v8, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v13}, Lax/y6/i;->c()J
    ...
    iget v6, v0, Lax/K6/c$e;->c:F

    invoke-static {v12, v3, v4, v10}, Lax/K6/a;->a(Lax/K6/c;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v13}, Lax/y6/i;->d()J

    move-result-wide v4

    iget-object v1, v8, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lax/y6/h;

    invoke-virtual {v1}, Lax/y6/h;->f()J
    ...
    :goto_0
    invoke-virtual {v13, v8}, Lax/y6/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v7, p8

    invoke-interface {v7, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v12}, Lax/K6/a;->b(Lax/K6/c;)Landroid/animation/Animator$AnimatorListener;
...
.method private d0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_2
    sget-object p3, Lax/y6/e;->a:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Lax/y6/h;->e(Ljava/lang/String;)Lax/y6/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Lax/y6/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Lcom/google/android/material/transformation/FabTransformationBehavior$c;

    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lax/K6/c;Landroid/graphics/drawable/Drawable;)V
...
.method private g0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v4, v2, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lax/y6/j;

    invoke-direct {p0, p1, p2, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->U(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F

    move-result v4

    iget-object v5, v2, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lax/y6/j;

    invoke-direct {p0, p1, p2, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->V(Landroid/view/View;Landroid/view/View;Lax/y6/j;)F
    ...
    check-cast v6, Lax/y6/i;

    iget-object v5, v5, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast v5, Lax/y6/i;
    ...
    invoke-direct/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lax/y6/i;Lax/y6/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_0
    invoke-virtual {v6, v11}, Lax/y6/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v0, v12}, Lax/y6/i;->a(Landroid/animation/Animator;)V
...
.method protected N(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    iput v0, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->m0:F

    invoke-virtual {p1}, Landroid/view/View;->getTranslationY()F

    move-result v0

    iput v0, p0, Lcom/google/android/material/transformation/FabTransformationBehavior;->n0:F
    ...
    invoke-static {p1, v7}, Lax/y6/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
