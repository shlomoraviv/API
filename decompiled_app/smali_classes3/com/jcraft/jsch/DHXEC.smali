...
.field private C:Lcom/jcraft/jsch/XDH;
...
.method public k()I
    ...
    iget v0, p0, Lcom/jcraft/jsch/DHXEC;->u:I
...
.method public m(Lcom/jcraft/jsch/Session;[B[B[B[B)V
    ...
    iput-object p2, p0, Lcom/jcraft/jsch/DHXEC;->w:[B

    iput-object p3, p0, Lcom/jcraft/jsch/DHXEC;->x:[B

    iput-object p4, p0, Lcom/jcraft/jsch/DHXEC;->y:[B

    iput-object p5, p0, Lcom/jcraft/jsch/DHXEC;->z:[B

    :try_start_0
    iget-object p3, p0, Lcom/jcraft/jsch/DHXEC;->D:Ljava/lang/String;
    ...
    iput-object p3, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;

    new-instance p3, Lcom/jcraft/jsch/Packet;

    iget-object p5, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;

    invoke-direct {p3, p5}, Lcom/jcraft/jsch/Packet;-><init>(Lcom/jcraft/jsch/Buffer;)V

    iput-object p3, p0, Lcom/jcraft/jsch/DHXEC;->B:Lcom/jcraft/jsch/Packet;

    invoke-virtual {p3}, Lcom/jcraft/jsch/Packet;->c()V

    iget-object p3, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;
    ...
    iput-object p3, p0, Lcom/jcraft/jsch/DHXEC;->C:Lcom/jcraft/jsch/XDH;

    iget-object p4, p0, Lcom/jcraft/jsch/DHXEC;->E:Ljava/lang/String;

    iget p5, p0, Lcom/jcraft/jsch/DHXEC;->F:I

    invoke-interface {p3, p4, p5}, Lcom/jcraft/jsch/XDH;->d(Ljava/lang/String;I)V

    iget-object p3, p0, Lcom/jcraft/jsch/DHXEC;->C:Lcom/jcraft/jsch/XDH;

    invoke-interface {p3}, Lcom/jcraft/jsch/XDH;->a()[B

    move-result-object p3

    iput-object p3, p0, Lcom/jcraft/jsch/DHXEC;->v:[B

    iget-object p4, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;
    ...
    :cond_0
    iget-object p2, p0, Lcom/jcraft/jsch/DHXEC;->B:Lcom/jcraft/jsch/Packet;
    ...
    iput p1, p0, Lcom/jcraft/jsch/DHXEC;->u:I
...
.method public n(Lcom/jcraft/jsch/Buffer;)Z
    ...
    iget-object v2, p0, Lcom/jcraft/jsch/DHXEC;->C:Lcom/jcraft/jsch/XDH;

    invoke-interface {v2, v0}, Lcom/jcraft/jsch/XDH;->c([B)Z
    ...
    invoke-interface {v2, v0}, Lcom/jcraft/jsch/XDH;->b([B)[B
    ...
    iget-object v2, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;

    invoke-virtual {v2}, Lcom/jcraft/jsch/Buffer;->A()V

    iget-object v2, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;

    iget-object v4, p0, Lcom/jcraft/jsch/DHXEC;->x:[B

    invoke-virtual {v2, v4}, Lcom/jcraft/jsch/Buffer;->y([B)V

    iget-object v2, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;

    iget-object v4, p0, Lcom/jcraft/jsch/DHXEC;->w:[B

    invoke-virtual {v2, v4}, Lcom/jcraft/jsch/Buffer;->y([B)V

    iget-object v2, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;

    iget-object v4, p0, Lcom/jcraft/jsch/DHXEC;->z:[B

    invoke-virtual {v2, v4}, Lcom/jcraft/jsch/Buffer;->y([B)V

    iget-object v2, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;

    iget-object v4, p0, Lcom/jcraft/jsch/DHXEC;->y:[B
    ...
    iget-object v4, p0, Lcom/jcraft/jsch/DHXEC;->v:[B
    ...
    iget-object v0, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;
    ...
    iget-object v4, p0, Lcom/jcraft/jsch/DHXEC;->A:Lcom/jcraft/jsch/Buffer;
    ...
    iput v1, p0, Lcom/jcraft/jsch/DHXEC;->u:I
