...
# instance fields
.field private A:Lcom/jcraft/jsch/Buffer;

.field private B:Lcom/jcraft/jsch/Packet;

.field private C:Lcom/jcraft/jsch/ECDH;
...
.method public k()I
    ...
    iget v0, p0, Lcom/jcraft/jsch/DHECN;->u:I
...
.method public m(Lcom/jcraft/jsch/Session;[B[B[B[B)V
    ...
    iput-object p2, p0, Lcom/jcraft/jsch/DHECN;->w:[B

    iput-object p3, p0, Lcom/jcraft/jsch/DHECN;->x:[B

    iput-object p4, p0, Lcom/jcraft/jsch/DHECN;->y:[B

    iput-object p5, p0, Lcom/jcraft/jsch/DHECN;->z:[B

    :try_start_0
    iget-object p3, p0, Lcom/jcraft/jsch/DHECN;->D:Ljava/lang/String;
    ...
    iput-object p3, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;

    new-instance p3, Lcom/jcraft/jsch/Packet;

    iget-object p5, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;

    invoke-direct {p3, p5}, Lcom/jcraft/jsch/Packet;-><init>(Lcom/jcraft/jsch/Buffer;)V

    iput-object p3, p0, Lcom/jcraft/jsch/DHECN;->B:Lcom/jcraft/jsch/Packet;

    invoke-virtual {p3}, Lcom/jcraft/jsch/Packet;->c()V

    iget-object p3, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;

    const/16 p5, 0x1e

    invoke-virtual {p3, p5}, Lcom/jcraft/jsch/Buffer;->s(B)V
    ...
    iput-object p3, p0, Lcom/jcraft/jsch/DHECN;->C:Lcom/jcraft/jsch/ECDH;

    iget p4, p0, Lcom/jcraft/jsch/DHECN;->E:I

    invoke-interface {p3, p4}, Lcom/jcraft/jsch/ECDH;->b(I)V

    iget-object p3, p0, Lcom/jcraft/jsch/DHECN;->C:Lcom/jcraft/jsch/ECDH;

    invoke-interface {p3}, Lcom/jcraft/jsch/ECDH;->a()[B

    move-result-object p3

    iput-object p3, p0, Lcom/jcraft/jsch/DHECN;->v:[B

    iget-object p4, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;
    ...
    :cond_0
    iget-object p2, p0, Lcom/jcraft/jsch/DHECN;->B:Lcom/jcraft/jsch/Packet;
    ...
    iput p1, p0, Lcom/jcraft/jsch/DHECN;->u:I
...
.method public n(Lcom/jcraft/jsch/Buffer;)Z
    ...
    invoke-static {v0}, Lcom/jcraft/jsch/KeyPairECDSA;->H([B)[[B

    move-result-object v2

    iget-object v4, p0, Lcom/jcraft/jsch/DHECN;->C:Lcom/jcraft/jsch/ECDH;
    ...
    invoke-interface {v4, v5, v7}, Lcom/jcraft/jsch/ECDH;->d([B[B)Z
    ...
    invoke-interface {v4, v5, v2}, Lcom/jcraft/jsch/ECDH;->c([B[B)[B
    ...
    iget-object v2, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;

    invoke-virtual {v2}, Lcom/jcraft/jsch/Buffer;->A()V

    iget-object v2, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;

    iget-object v4, p0, Lcom/jcraft/jsch/DHECN;->x:[B

    invoke-virtual {v2, v4}, Lcom/jcraft/jsch/Buffer;->y([B)V

    iget-object v2, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;

    iget-object v4, p0, Lcom/jcraft/jsch/DHECN;->w:[B

    invoke-virtual {v2, v4}, Lcom/jcraft/jsch/Buffer;->y([B)V

    iget-object v2, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;

    iget-object v4, p0, Lcom/jcraft/jsch/DHECN;->z:[B

    invoke-virtual {v2, v4}, Lcom/jcraft/jsch/Buffer;->y([B)V

    iget-object v2, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;

    iget-object v4, p0, Lcom/jcraft/jsch/DHECN;->y:[B
    ...
    iget-object v4, p0, Lcom/jcraft/jsch/DHECN;->v:[B
    ...
    iget-object v0, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;
    ...
    iget-object v4, p0, Lcom/jcraft/jsch/DHECN;->A:Lcom/jcraft/jsch/Buffer;
    ...
    iput v1, p0, Lcom/jcraft/jsch/DHECN;->u:I
