...
# instance fields
.field private final a:Lax/f6/sc;
...
.method public constructor <init>(III)V
    ...
    iput p1, p0, Lax/f6/Dc;->c:I

    goto :goto_0

    :cond_2
    iput p3, p0, Lax/f6/Dc;->c:I

    :goto_0
    new-instance p1, Lax/f6/Bc;

    invoke-direct {p1, p2}, Lax/f6/Bc;-><init>(I)V

    iput-object p1, p0, Lax/f6/Dc;->a:Lax/f6/sc;
...
.method public final a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    new-instance v2, Lax/f6/Cc;

    invoke-direct {v2, v1}, Lax/f6/Cc;-><init>(Lax/f6/Dc;)V
    ...
    check-cast v5, Lax/f6/rc;

    invoke-virtual {v5}, Lax/f6/rc;->e()I
    ...
    :cond_8
    :goto_5
    invoke-static {v8, v10}, Lax/f6/wc;->b(Ljava/lang/String;Z)[Ljava/lang/String;

    move-result-object v3

    array-length v8, v3

    iget v9, v1, Lax/f6/Dc;->c:I
    ...
    :cond_10
    :goto_b
    new-instance v3, Lax/f6/uc;

    invoke-direct {v3}, Lax/f6/uc;-><init>()V
    ...
    :try_start_0
    iget-object v4, v1, Lax/f6/Dc;->a:Lax/f6/sc;

    invoke-virtual {v4, v2}, Lax/f6/sc;->b(Ljava/lang/String;)[B

    move-result-object v2

    iget-object v4, v3, Lax/f6/uc;->b:Landroid/util/Base64OutputStream;
    ...
    :cond_11
    invoke-virtual {v3}, Lax/f6/uc;->toString()Ljava/lang/String;
