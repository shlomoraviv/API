...
.method protected final e()Lax/I7/d;
    ...
    invoke-direct {v4}, Lax/w5/d2;-><init>()V
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/google/android/gms/ads/internal/ClientApi;->M2(Lax/d6/a;Lax/w5/d2;Ljava/lang/String;Lax/f6/dm;I)Lax/w5/V;
    ...
    new-instance v4, Lax/f6/Va0;

    invoke-direct {v4, p0, v1, v0}, Lax/f6/Va0;-><init>(Lax/f6/Wa0;Lax/f6/pl0;Lax/w5/V;)V

    invoke-interface {v0, v3, v4}, Lax/w5/V;->l1(Lax/w5/Y1;Lax/w5/K;)V
    :try_end_0
...
.method protected final bridge synthetic f(Ljava/lang/Object;)Lj$/util/Optional;
    ...
    :try_start_0
    invoke-interface {p1}, Lax/w5/V;->k()Lax/w5/U0;
