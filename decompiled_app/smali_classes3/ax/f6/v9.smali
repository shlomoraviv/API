...
.field private final b:Lax/f6/fa;

.field private final c:Lax/f6/s8;


# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;Lax/f6/s8;Lax/f6/fa;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p4, p0, Lax/f6/v9;->b:Lax/f6/fa;

    iput-object p3, p0, Lax/f6/v9;->c:Lax/f6/s8;

    new-instance p3, Lax/f6/p9;

    invoke-direct {p3, p0, p1}, Lax/f6/p9;-><init>(Lax/f6/v9;Landroid/content/Context;)V

    invoke-static {p3, p2}, Lax/f6/Uk0;->j(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lax/I7/d;

    move-result-object p1

    iput-object p1, p0, Lax/f6/v9;->a:Lax/I7/d;
...
.method private static c(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {}, Lax/f6/zj0;->g()Lax/f6/zj0;

    move-result-object v0

    invoke-virtual {v0}, Lax/f6/zj0;->e()Lax/f6/zj0;
    ...
    invoke-virtual {v0, v1, v4, v2}, Lax/f6/zj0;->h([BII)Ljava/lang/String;
...
.method private final d(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lax/f6/v9;->b:Lax/f6/fa;
    ...
    iget-object v0, p0, Lax/f6/v9;->c:Lax/f6/s8;

    invoke-virtual {v0}, Lax/f6/s8;->h0()Z
    ...
    iget-object v3, p0, Lax/f6/v9;->c:Lax/f6/s8;

    invoke-virtual {v3}, Lax/f6/s8;->d0()I
    ...
    :try_start_1
    invoke-static {v4}, Lax/f6/Uk0;->h(Ljava/lang/Object;)Lax/I7/d;
    ...
    invoke-virtual {v3}, Lax/f6/zj0;->e()Lax/f6/zj0;
    ...
    invoke-virtual {v3, v5}, Lax/f6/zj0;->i(Ljava/lang/CharSequence;)[B
    ...
    :cond_4
    new-instance v10, Lax/f6/t9;

    invoke-direct {v10}, Lax/f6/t9;-><init>()V
    ...
    invoke-static/range {v5 .. v10}, Lax/f6/u9;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;ZILjava/util/List;Landroid/content/pm/PackageManager$OnChecksumsReadyListener;)V

    iget-object v1, v10, Lax/f6/t9;->a:Lax/f6/pl0;
    :try_end_2
    ...
    iget-object v1, p0, Lax/f6/v9;->c:Lax/f6/s8;

    invoke-virtual {v1}, Lax/f6/s8;->g0()Z
    ...
    :try_start_4
    invoke-static {p1}, Lax/f6/v9;->c(Landroid/content/Context;)Ljava/lang/String;
...
.method public final a()Lax/I7/d;
    ...
    iget-object v0, p0, Lax/f6/v9;->a:Lax/I7/d;
...
.method final synthetic b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lax/f6/v9;->d(Landroid/content/Context;)Ljava/lang/String;
