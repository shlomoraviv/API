...
.method public final h()Lax/w5/U0;
    ...
    invoke-static {v1}, Lax/w5/T0;->W7(Landroid/os/IBinder;)Lax/w5/U0;
...
.method public final i()Lax/f6/mh;
    ...
    instance-of v3, v2, Lax/f6/mh;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lax/f6/mh;

    goto :goto_0

    :cond_1
    new-instance v2, Lax/f6/kh;

    invoke-direct {v2, v1}, Lax/f6/kh;-><init>(Landroid/os/IBinder;)V
...
.method public final j()Lax/f6/qh;
    ...
    instance-of v3, v2, Lax/f6/qh;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lax/f6/qh;

    goto :goto_0

    :cond_1
    new-instance v2, Lax/f6/oh;

    invoke-direct {v2, v1}, Lax/f6/oh;-><init>(Landroid/os/IBinder;)V
...
.method public final k()Lax/f6/th;
    ...
    check-cast v1, Lax/f6/th;

    goto :goto_0

    :cond_1
    new-instance v2, Lax/f6/rh;

    invoke-direct {v2, v1}, Lax/f6/rh;-><init>(Landroid/os/IBinder;)V
