...
.field private static final zzu:Lax/f6/fe;

.field private static volatile zzv:Lax/f6/Pw0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lax/f6/Pw0<",
            "Lax/f6/fe;",
...
# instance fields
.field private zzA:Lax/f6/He;

.field private zzB:Lax/f6/he;

.field private zzC:Lax/f6/Be;

.field private zzD:Lax/f6/ne;

.field private zzE:I

.field private zzF:I

.field private zzG:Lax/f6/be;
...
.field private zzx:Lax/f6/ze;

.field private zzy:Lax/f6/De;

.field private zzz:Lax/f6/Fe;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lax/f6/fe;-><init>()V

    sput-object v0, Lax/f6/fe;->zzu:Lax/f6/fe;

    const-class v1, Lax/f6/fe;
...
.method static bridge synthetic d0()Lax/f6/fe;
    .locals 1

    sget-object v0, Lax/f6/fe;->zzu:Lax/f6/fe;
...
.method protected final Y(Lax/f6/Vv0;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p1, Lax/f6/fe;->zzv:Lax/f6/Pw0;

    if-nez p1, :cond_1

    const-class p2, Lax/f6/fe;
    ...
    sget-object p3, Lax/f6/fe;->zzu:Lax/f6/fe;

    invoke-direct {p1, p3}, Lax/f6/Rv0;-><init>(Lax/f6/Wv0;)V

    sput-object p1, Lax/f6/fe;->zzv:Lax/f6/Pw0;
    ...
    :cond_3
    sget-object p1, Lax/f6/fe;->zzu:Lax/f6/fe;

    return-object p1

    :cond_4
    new-instance p1, Lax/f6/ee;

    invoke-direct {p1, p2}, Lax/f6/ee;-><init>(Lax/f6/kf;)V

    return-object p1

    :cond_5
    new-instance p1, Lax/f6/fe;

    invoke-direct {p1}, Lax/f6/fe;-><init>()V
    ...
    sget-object p2, Lax/f6/fe;->zzu:Lax/f6/fe;
