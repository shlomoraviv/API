...
.method private static c(Ljava/lang/String;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p0, v0}, Lax/U6/i;->e(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0, v0}, Lax/U6/i;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lax/U6/i;->a([Ljava/lang/String;I)F

    move-result v0

    const/4 v1, 0x1

    invoke-static {p0, v1}, Lax/U6/i;->a([Ljava/lang/String;I)F

    move-result v1

    const/4 v2, 0x2

    invoke-static {p0, v2}, Lax/U6/i;->a([Ljava/lang/String;I)F

    move-result v2

    const/4 v3, 0x3

    invoke-static {p0, v3}, Lax/U6/i;->a([Ljava/lang/String;I)F
    ...
    invoke-static {p0}, Lax/T/d;->e(Ljava/lang/String;)Landroid/graphics/Path;
...
.method public static f(Landroid/content/Context;II)I
    ...
    invoke-static {p0, p1, p2}, Lax/X6/b;->d(Landroid/content/Context;II)I
...
.method public static g(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p1}, Lax/U6/i;->d(Ljava/lang/String;)Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-static {p1}, Lax/U6/i;->c(Ljava/lang/String;)Landroid/animation/TimeInterpolator;
...
.method public static h(Landroid/content/Context;II)Lax/u0/l;
    .locals 2
    ...
    invoke-virtual {p1, p2}, Lax/u0/l;->h(F)Lax/u0/l;

    invoke-virtual {p1, v1}, Lax/u0/l;->f(F)Lax/u0/l;
    :try_end_0
