...
.method public synthetic constructor <init>(Ljava/util/stream/LongStream;)V
    ...
    iput-object p1, p0, Lj$/util/stream/h0;->a:Ljava/util/stream/LongStream;

    return-void
.end method

.method public static synthetic j(Ljava/util/stream/LongStream;)Lj$/util/stream/j0;
    .locals 1
    ...
    iget-object p0, p0, Lj$/util/stream/i0;->a:Lj$/util/stream/j0;
    ...
    invoke-direct {v0, p0}, Lj$/util/stream/h0;-><init>(Ljava/util/stream/LongStream;)V
...
# virtual methods
.method public final synthetic a()Lj$/util/stream/j0;
    .locals 2

    const/4 v0, 0x0

    iget-object v1, p0, Lj$/util/stream/h0;->a:Ljava/util/stream/LongStream;
    ...
    invoke-static {v0}, Lj$/util/stream/h0;->j(Ljava/util/stream/LongStream;)Lj$/util/stream/j0;
...
.method public final synthetic asDoubleStream()Lj$/util/stream/B;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/h0;->a:Ljava/util/stream/LongStream;

    invoke-interface {v0}, Ljava/util/stream/LongStream;->asDoubleStream()Ljava/util/stream/DoubleStream;

    move-result-object v0

    invoke-static {v0}, Lj$/util/stream/z;->j(Ljava/util/stream/DoubleStream;)Lj$/util/stream/B;
...
.method public final synthetic b()Lj$/util/stream/j0;
    .locals 2
...
.method public final synthetic boxed()Lj$/util/stream/Stream;
    ...
    invoke-static {v0}, Lj$/util/stream/S2;->j(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic d()Lj$/util/stream/j0;
    .locals 2
...
.method public final synthetic distinct()Lj$/util/stream/j0;
    .locals 1
...
.method public final synthetic e()Lj$/util/stream/j0;
    .locals 2
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Lj$/util/stream/h0;

    if-eqz v1, :cond_0

    check-cast p1, Lj$/util/stream/h0;

    iget-object p1, p1, Lj$/util/stream/h0;->a:Ljava/util/stream/LongStream;
...
.method public final synthetic findAny()Lj$/util/m;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->D(Ljava/util/OptionalLong;)Lj$/util/m;
...
.method public final synthetic iterator()Lj$/util/y;
    ...
    iget-object v0, v0, Lj$/util/x;->a:Lj$/util/y;
    ...
    invoke-direct {v1, v0}, Lj$/util/w;-><init>(Ljava/util/PrimitiveIterator$OfLong;)V
...
.method public final synthetic l()Lj$/util/stream/B;
    .locals 2
...
.method public final synthetic limit(J)Lj$/util/stream/j0;
    .locals 1
...
.method public final synthetic onClose(Ljava/lang/Runnable;)Lj$/util/stream/g;
    ...
    invoke-static {p1}, Lj$/util/stream/e;->j(Ljava/util/stream/BaseStream;)Lj$/util/stream/g;
...
.method public final synthetic parallel()Lj$/util/stream/g;
    ...
    invoke-static {v0}, Lj$/util/stream/e;->j(Ljava/util/stream/BaseStream;)Lj$/util/stream/g;
...
.method public final synthetic parallel()Lj$/util/stream/j0;
    .locals 1
...
.method public final synthetic peek(Ljava/util/function/LongConsumer;)Lj$/util/stream/j0;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/m;
    .locals 1
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->D(Ljava/util/OptionalLong;)Lj$/util/m;
...
.method public final synthetic sequential()Lj$/util/stream/j0;
    .locals 1
...
.method public final synthetic skip(J)Lj$/util/stream/j0;
    .locals 1
...
.method public final synthetic sorted()Lj$/util/stream/j0;
    .locals 1
...
.method public final synthetic spliterator()Lj$/util/J;
    ...
    invoke-static {v0}, Lj$/util/H;->a(Ljava/util/Spliterator$OfLong;)Lj$/util/J;
