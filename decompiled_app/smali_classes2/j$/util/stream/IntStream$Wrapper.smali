...
.method public final synthetic asDoubleStream()Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asDoubleStream()Lj$/util/stream/B;
...
.method public final synthetic asLongStream()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asLongStream()Lj$/util/stream/j0;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->H(Lj$/util/l;)Ljava/util/OptionalInt;
...
.method public final flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, v1}, Lj$/util/stream/IntStream;->B(Lj$/util/stream/J;)Lj$/util/stream/IntStream;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->iterator()Lj$/util/u;
    ...
    iget-object v0, v0, Lj$/util/s;->a:Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-direct {v1, v0}, Lj$/util/t;-><init>(Lj$/util/u;)V
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->f()Lj$/util/stream/B;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->m()Lj$/util/stream/j0;
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->H(Lj$/util/l;)Ljava/util/OptionalInt;
